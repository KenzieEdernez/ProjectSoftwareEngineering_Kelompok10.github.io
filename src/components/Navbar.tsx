      ...
      <ul className="flex items-center justify-between mx-20">
        <div className="flex space-x-14">
          ...
          <div className="flex space-x-4">
            <li>
              <a href="/about" className="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Now Playing</a>
            </li>
            <li>
              <a href="/contact" className="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Up Coming</a>
            </li>
            <li>
              <a href="/contact" className="text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Theaters</a>
            </li>
          </div>
        </div>
